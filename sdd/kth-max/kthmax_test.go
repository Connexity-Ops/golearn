...
func TestKthMaxInt(t *testing.T) {
	...
	normal_numbers := []int{515,818,-409,327,542,-607,387,811,529,768,235,625,146,749,774,800,329,125,616,596,811}
	...
	tests := []struct {
		...
		{
			name: "Normal maximum",
			args: args{k: 1, numbers: normal_numbers},
			wants: wants{kmax: 818},
		},
		{
			name: "k=2 normal maximum",
			args: args{k: 2, numbers: normal_numbers},
			wants: wants{kmax: 811},
		},
		{
			name: "k=7 normal maximum",
			args: args{k: 7, numbers: normal_numbers},
			wants: wants{kmax: 625},
		},
		{
			name: "k=20 normal maximum",
			args: args{k: 20, numbers: normal_numbers},
			wants: wants{kmax: -607},
		},	
		{
			name: "k=20 short 5 element maximum",
			args: args{k: 20, numbers: normal_numbers[:5]},
		...
		},			
		{
			...
			args: args{k: 1, numbers: normal_numbers[:1]},
		...
		},			
		{
			...
			args: args{k: 0, numbers: normal_numbers},
